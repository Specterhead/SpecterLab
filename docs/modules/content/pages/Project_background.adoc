...
information is secure and that I have the final say in what is done with it.
...
3. Include a space for personal documentation.footnote:[Obviously my personal documentation for the home server build 
outgrew the server itself and information is now hosted externally through this site.] and note collection. 
